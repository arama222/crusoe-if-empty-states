    ...
    fullSteps: [
      ...
      { title: 'Choose a model', desc: 'Select a model — the code example updates automatically.',
        action: { type: 'model', brand: 'Meta', name: 'Llama 3.3 70B Instruct', meta: 'LLM · 131k context',
          price: '$0.25 In · $0.13 Cached · $0.75 Out',
          note: 'Try the selected model in the Playground, or explore all available models — NVIDIA Nemotron, Gemma, GPT-OSS and more.',
